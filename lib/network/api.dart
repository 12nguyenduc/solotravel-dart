...
class Api {
  ...
  PublishSubject<Map<String, dynamic>> callAPI(Method method, {String link, Map<String, String> params, Map<String, String> headers }){
    String id = uuid.v4();
    var code = '''
    ...
    instance.${mapMethodAxios(method)}('${link +
